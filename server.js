...
app.post('/api/create-ticket', upload.single('profilePicture'), async (req, res) => {
...
app.post('/api/update-ticket', upload.single('profilePicture'), async (req, res) => {
...
app.post('/api/verify-invite-code', (req, res) => {
    ...
    res.json({ success: false, message: 'Invalid invitation code or ticket not found.' });
});
